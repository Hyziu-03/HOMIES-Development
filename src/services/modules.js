 ...
 * @returns {boolean} Information if the user has entered valid names
 */
 ...
 * @returns {boolean} Information if the password has enough strength based on schema 
 */
 ...
 * @returns Information if the user has entered a valid email adress
 */
 ...
 * @param {function} nameRule Password validation
...
/**
 * Making sure that pressing the enter key toggles click 
 */
...
/**
 * Mapping non-latin characters to latin characters
 */
Latinise.latin_map = {
...
/**
 * Replacing characters to only those that are latin
 * @returns {string} text with only latin characters 
 */
...
/**
 * Checking if the string contains only latin characters 
 * @returns {boolean} Information if a string contains only latin characters
 */
